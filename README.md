...
### 📸 Pour tes captures GitHub

Je te conseille également de créer dans ton dépôt un dossier :

```text
Screenshots/
````

et d'y mettre tes captures :
...
├── repartition.png
├── verification.png
├── ajout-utilisateur.png
└── diagramme.png
```

Ensuite, tu peux ajouter dans le README une section comme :
...
![<img width="873" height="546" alt="image" src="https://github.com/user-attachments/assets/c2da22c5-721e-418d-8868-ba5aa28e7420" />
](Screenshots/login.png)

## 💰 Répartition du salaire

![<img width="792" height="567" alt="image" src="https://github.com/user-attachments/assets/7f276065-999d-43cf-b4b9-92d025ffd212" />
](Screenshots/repartition.png)

## 🔎 Vérification des données

![<img width="1281" height="516" alt="image" src="https://github.com/user-attachments/assets/c0c4af40-e208-42d8-be0f-cbabbaf67ab1" />
](Screenshots/verification.png)

## 👤 Ajout d'utilisateur

![<img width="796" height="550" alt="image" src="https://github.com/user-attachments/assets/4fc2edd1-a78c-4ea2-814e-ee3e4725bc30" />
](Screenshots/ajout-utilisateur.png)

## 📊 Diagrammes et statistiques

![<img width="1918" height="1006" alt="image" src="https://github.com/user-attachments/assets/13ca3dd7-86ab-4143-a35a-bd52e63ea0a1" />
](Screenshots/diagramme.png)
```

**Important :** les noms `Screenshots/login.png`, etc. doivent correspondre exactement aux noms des fichiers que tu téléverses dans ton dépôt GitHub.
