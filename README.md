...
![Interface Login](Screenshots/login.png)

## 💰 Répartition du salaire

![Répartition salaire](Screenshots/repartition.png)

## 🔎 Vérification des données

![Vérification](Screenshots/verification.png)

## 👤 Ajout d'utilisateur

![Ajout utilisateur](Screenshots/ajout-utilisateur.png)
